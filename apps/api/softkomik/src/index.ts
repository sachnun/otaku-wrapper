                  ...
                  data: [
                    {
                      title: 'One Piece',
                      slug: 'one-piece',
                      url: 'https://softkomik.com/one-piece-bahasa-indonesia',
                      thumbnail: 'https://image.softkomik.com/image-cover/one-piece.webp',
                      type: 'manga',
                      status: 'ongoing',
                      latestChapter: '1130',
              ...
              'application/json': {
                ...
                example: {
                  ...
                  data: {
                    ...
                    totalChapters: 180,
                    chapters: [
                      { number: '179.5', url: 'https://softkomik.com/solo-leveling-bahasa-indonesia/chapter/179.5' },
                      { number: '179', url: 'https://softkomik.com/solo-leveling-bahasa-indonesia/chapter/179' }
                    ]
                  }
                }
              }
              ...
              'application/json': {
                ...
                example: {
                  ...
                  data: {
                    ...
                    chapterNumber: '179',
                    images: [
                      'https://image.softkomik.com/softkomik/NodeJs/new-nodeJs/solo-leveling-bahasa-indonesia/chapter-179/softkomik-0.webp',
                      'https://image.softkomik.com/softkomik/NodeJs/new-nodeJs/solo-leveling-bahasa-indonesia/chapter-179/softkomik-1.webp'
                    ],
                    prevChapter: '178',
                    nextChapter: '179.5'
                  }
          ...
          '400': {
            ...
            content: {
              'application/json': {
                ...
                example: {
                  success: false,
                  error: 'Invalid type. Valid types: manga, manhwa, manhua'
                }
              }
            }
          }
                  ...
                  data: [
                    {
                      title: 'One Punch Man',
                      slug: 'one-punch-man',
                      url: 'https://softkomik.com/one-punch-man-bahasa-indonesia',
                      thumbnail: 'https://image.softkomik.com/image-cover/one-punch-man.webp',
                      type: 'manga',
                      status: 'ongoing',
                      latestChapter: '200',
    ...
    schemas: {
      ComicListing: {
        ...
        properties: {
          ...
          visitor: { type: 'integer', nullable: true, description: 'View count' }
        }
      },
      ComicDetail: {
        type: 'object',
...
// Get chapter list
app.get('/api/comics/:slug/chapters', async (c) => {
  const { slug } = c.req.param()
